...
CWD = '/home/mcw/durga/kaldi/egs/gop_speechocean762/s5'
# CWD = '/home/mcw/durga/reference/kaldi/egs/gop_speechocean762/s5'
FRAME_SHIFT = 10
...
def parse_phones(filename):
    ...
    for pl in phone_lines:
        if filename == '/home/mcw/durga/kaldi/egs/gop_speechocean762/s5/exp/gop_test_api/phone-to-pure-phone.int':
            phones_ids = pl.split(' ')
            #print(phones_ids)
        else:
            phones_ids = pl.split('\t')
...
with open("main_log.txt", "w") as f:
	...
	data_dir = '/home/mcw/durga/kaldi/egs/gop_speechocean762/s5/data/test_api'
