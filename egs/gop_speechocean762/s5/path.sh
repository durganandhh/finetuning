...
export PATH=$KALDI_ROOT/src/bin:$KALDI_ROOT/src/featbin:$KALDI_ROOT/src/gmmbin:$KALDI_ROOT/src/lmbin:$KALDI_ROOT/src/nnet3bin:$KALDI_ROOT/src/online2bin:$PATH
